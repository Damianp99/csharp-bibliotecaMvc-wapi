...
namespace csharp_bibliotecaMvc.Data
{
    public class DbInitializer
    {
        public static void Initialize(BibliotecaContext context)
        {
            ...
            {
            new Utente{Nome="Damian",Cognome="Perez",Telefono="4312", Email="damian.perez@gmail.com",Password="65123"},
            new Utente{Nome="Marco",Cognome="Sanchez",Telefono="1459", Email="franco.sanchez@gmail.com",Password="75332", }
            };
